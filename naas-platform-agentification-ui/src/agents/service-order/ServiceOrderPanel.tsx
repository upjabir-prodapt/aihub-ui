...
import type { RecommendationResult, ServiceOrderState } from './types';
import CityMap, { WorldMap, type CityMapPoint } from '../../components/CityMap';
...
// ChatScreen accumulates tool_results for the whole chat session and
