...
import PricingOptions from '../agents/service-order/PricingOptions';
import RecommendationOptions from '../agents/service-order/RecommendationOptions';
import BuildingSearch from '../agents/service-order/BuildingSearch';
import BandwidthOptions from '../agents/service-order/BandwidthOptions';
import type {
  InvoiceResult,
...
} from '../agents/service-order/types';
import CircuitTable from '../agents/sre-monitor/CircuitTable';
import TimePeriodTable from '../agents/sre-monitor/TimePeriodTable';
import type {
  ListActiveCircuitsResult,
  PresentTimePeriodOptionsResult,
} from '../agents/sre-monitor/types';
import CircuitRulesTable from '../agents/sre-closed-loop/CircuitRulesTable';
import AuditLogTable from '../agents/sre-closed-loop/AuditLogTable';
import type { ReliabilityAuditEntry, ReliabilityRule } from '../api/types';
...
// keyed off that turn's tool_results. ChatPanel calls this
// unconditionally for every turn, in both the embedded orchestrator
// chat (ChatScreen.tsx) and every standalone specialist screen
// (AgentScreen.tsx) — every tool name checked below is unique to its own
// specialist EXCEPT list_active_circuits, which both the Service
...
// in sync with the active language: ChatPanel.tsx (the only caller)
