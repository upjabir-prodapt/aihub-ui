...
import SalesFeedbackModal from './SalesFeedbackModal';
import '../../styles/service-detail.css';
import '../../styles/sales-agent.css';
// SalesFeedbackModal reuses the generic modal/review-* classes defined here
// alongside Translation's ReviewModal (see features/translation/ReviewModal.tsx).
...
const SalesAgentPage: React.FC<SalesAgentPageProps> = ({ onOpenTracker, onBack }) => {
  ...
  const startResearch = async () => {
    ...
    try {
      ...
      // Tracker can see this run too (see features/sales/useSalesJobsState.ts).
  ...
  // ── Authenticated app (RequireRole guarantees the sales entitlement) ───────
  return (
