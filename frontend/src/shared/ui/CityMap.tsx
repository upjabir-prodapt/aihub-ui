...
// (e.g. source vs. destination) — omitted, both points fall back to
// aihub's teal accent color, preserving every existing caller's current
// look exactly.
...
const DEFAULT_MARKER_COLOR = 'var(--colt-teal)';
