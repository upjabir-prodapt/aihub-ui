...
// series (aihub's brand teal, per the dataviz skill's "one hue" rule for
// a lone trend line) with a crosshair + tooltip.
export default function LineChart({
  ...
  return (
    <div className="line-chart-card">
      ...
      {dataPoints.length === 0 ? (
        <div className="line-chart-empty">{t('emptyStates.noDataAvailable')}</div>
      ) : (
        <svg
